...
// Official brand glyph paths (24x24 viewBox, single path each).
...
/** Raw brand mark, inherits `currentColor` unless a color class is applied via `className`. */
...
/** Circular badge with the brand mark on the platform's brand color. */
